...
const Achievement = () =>  {
  return (
    <section className="w-full py020">
        <h1 className="heading">
            My <span className="text-purple">Achievement</span>
        </h1>
...
const AceternityIcon = ({ order }: { order: string }) => {
  ...
  <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-5 py-2 text-white backdrop-blur-3xl text-1xl font-bold">
    {order}
  </span>
</button>
    </div>
